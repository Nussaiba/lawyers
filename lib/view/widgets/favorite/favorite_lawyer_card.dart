...
class CustomFavoriteLawyerCard extends StatelessWidget {
  const CustomFavoriteLawyerCard({
    super.key,
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              IconButton(
                onPressed: () {
                  // أضف هنا وظيفة الزر (مثل إضافة المحامي إلى المفضلين)
                  Get.snackbar('تمت الإضافة!', 'تم إضافة ${lawyer.name} إلى المفضلة');
                },
                icon: Icon(
                  Icons.favorite,
                  color: Colors.red,
