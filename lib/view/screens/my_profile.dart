...
import 'package:lawyer2/view/widgets/my_profile/app_bar.dart';
...
class MyProfile extends StatelessWidget {
  final Lawyer lawyer;
  const MyProfile({super.key, required this.lawyer});
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: AppBarMyProfileWidget(onTapdrawer: () {
                            //Get.back();
                          }),
                        ),
                        const SizedBox(
